...
mkdir tmp
cd tmp/
wget http://mirror.metrocast.net/apache/httpd/httpd-2.4.16.tar.gz
tar -zxf httpd-2.4.16.tar.gz
wget http://mirror.sdunix.com/apache//apr/apr-1.5.2.tar.gz
tar -zxf apr-1.5.2.tar.gz
mv apr-1.5.2 httpd-2.4.16/srclib/apr
wget http://mirror.sdunix.com/apache/apr/apr-util-1.5.4.tar.gz
tar -zxf apr-util-1.5.4.tar.gz
mv apr-util-1.5.2 httpd-2.4.16/srclib/apr-util
